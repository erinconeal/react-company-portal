...
},{"react-refresh/runtime":"fNmB3"}],"geSX2":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "670a5f7676595784";
"use strict";
...
},{}],"bDX1c":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$7bd5 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$7bd5.prelude(module);
...
var _useLazyLoading = _interopRequireDefault(require("./useLazyLoading"));
...
const Blog = ()=>{
    ...
    const [isFetchingData, setIsFetchingData] = _react.useState(false);
    const [images, setImages] = _react.useState([]);
    const [posts, setPosts] = _react.useState([]);
    const bottomBoundaryRef = _react.useRef(null);
    ...
    const [pager, pagerDispatch] = _react.useReducer(pageReducer, {
        page: 1
    });
    _react.useEffect(()=>{
        requestData(pager.page);
    }, [
        pager.page
    ]); // eslint-disable-line react-hooks/exhaustive-deps
    _useLazyLoading.default(".card-top", data);
    _useInfiniteScroll.default(bottomBoundaryRef, pagerDispatch);
    _react.useEffect(()=>{
        const combinedData = [];
        posts.forEach((item, i)=>{
            combinedData.push(Object.assign({
            }, item, images[i]));
        });
    ...
    async function requestPosts(page) {
        try {
            ...
            setPosts((posts1)=>posts1.concat(json)
            );
            return posts || [];
        } catch (error) {
            console.log(error);
        ...
        children: [
            ...
            /*#__PURE__*/ _jsxRuntime.jsx("div", {
                children: /*#__PURE__*/ _jsxRuntime.jsx("ul", {
                    className: "grid grid-flow-cols sm:grid-cols-2 blogs",
                    children: data.map((d, index)=>{
                        return(/*#__PURE__*/ _jsxRuntime.jsxs("li", {
                            className: "pr-5 card-top",
                            children: [
                                d !== null && d !== void 0 && d.download_url ? /*#__PURE__*/ _jsxRuntime.jsx("img", {
                                    alt: "",
                                ...
                                /*#__PURE__*/ _jsxRuntime.jsx("h2", {
                                    children: (d === null || d === void 0 ? void 0 : d.title) || /*#__PURE__*/ _jsxRuntime.jsx(_reactLoadingSkeleton.default, {
                                    })
                                }),
                                /*#__PURE__*/ _jsxRuntime.jsx("p", {
                                    children: (d === null || d === void 0 ? void 0 : d.body) || /*#__PURE__*/ _jsxRuntime.jsx(_reactLoadingSkeleton.default, {
                                        count: 3
                                    })
                                })
                            ]
            ...
            isFetchingData && /*#__PURE__*/ _jsxRuntime.jsx("div", {
...
$RefreshReg$(_c, "Blog");
  ...
  $parcel$ReactRefreshHelpers$7bd5.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react":"6TuXu","react-loading-skeleton":"ikS7l","./useInfiniteScroll":"1Uquk","./useLazyLoading":"kbXdO","react/jsx-runtime":"8xIwr","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"5V79J"}],"ikS7l":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"react":"6TuXu","@emotion/core":"jN46q","./skeleton":"h1MN2"}],"1Uquk":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$4180 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$4180.prelude(module);
...
const useInfiniteScroll = (scrollRef, dispatch)=>{
    const scrollObserver = _react.useCallback((node)=>{
        new IntersectionObserver((entries)=>{
            entries.forEach((en)=>{
                if (en.intersectionRatio > 0) dispatch({
                    type: "ADVANCE_PAGE"
                });
            });
        }).observe(node);
...
exports.default = _default;
  ...
  $parcel$ReactRefreshHelpers$4180.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react":"6TuXu","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"5V79J"}],"kbXdO":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$d775 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$d775.prelude(module);
...
const useLazyLoading = (elementSelector, items)=>{
    const observer = _react.useCallback((node)=>{
        const intObs = new IntersectionObserver((entries)=>{
            entries.forEach((en)=>{
                if (en.intersectionRatio > 0) {
                    const currentListItem = en.target;
                    const firstChild = currentListItem.children[0];
                    if (firstChild.tagName === "IMG") {
                        const newImgSrc = firstChild.dataset.src; // only swap out the image source if the new url exists
                        if (!newImgSrc) console.error("Image source is invalid");
                        else firstChild.src = newImgSrc;
                    }
    ...
    _react.useEffect(()=>{
        ...
        if (listRef.current) listRef.current.forEach((listItem)=>observer(listItem)
        );
    }, [
        observer,
        listRef,
...
var _default = useLazyLoading;
exports.default = _default;

  $parcel$ReactRefreshHelpers$d775.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react":"6TuXu","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"5V79J"}]},["2rAXy","geSX2"], null, "parcelRequireec75")

//# sourceMappingURL=Blog.76595784.js.map
