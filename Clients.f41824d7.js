    ...
    constructor(...args){
        ...
        _defineProperty(this, "updateClient", async (form, clientId, index)=>{
            try {
                ...
                this.setState(_immutabilityHelper.default(this.state.clients, {
                    $splice: [
                        [
                            updatedClientIndex,
                            1,
...
},{"react":"6TuXu","react-router-dom":"cpyQW","./ClientForm":"8zgTB","./ClientCard":"98VtH","./ClientSkeleton":"aKMBB","react/jsx-runtime":"8xIwr","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"5V79J","immutability-helper":"1hoLd"}],"8zgTB":[function(require,module,exports) {
...
class ClientForm extends _react.Component {
    ...
    render() {
        const { website , name , email , phone , address: { suite , street , city , zipcode  } , id  } = this.state.formInputs;
        return(/*#__PURE__*/ _jsxRuntime.jsxs("div", {
...
},{"react":"6TuXu","@emotion/core":"jN46q","./skeleton":"h1MN2"}],"1hoLd":[function(require,module,exports) {
...
},{}]},["2rAXy","fNlah"], null, "parcelRequireec75")
